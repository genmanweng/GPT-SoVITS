...
gr.temp_dir = "/home/gr/temp"  # os.environ.get("gr_temp_dir", "/home/gr/temp")
...
def change_sovits_weights(sovits_path, prompt_language=None, text_language=None):
    ...
    dict_language = (
        dict_language_v1 if tts_pipeline.configs.version == "v1" else dict_language_v2
    )
    ...
    with gr.Row():
        with gr.Column():
            ...
            with gr.Row():
                ...
                inp_refs = gr.File(
                    label=i18n("辅参考音频(可选多个，或不选)"), file_count="multiple"
                )
